...
nbr_fit = glm.nb(bcommits~lmax_commit_age+ltins+ldevs+lcommits+class, contrasts = list(class = Weighted_contrast_encoding(log_transform_df$class)), data=log_transform_df)

#fitting second NBR model 
nbr_fit_r = glm.nb(bcommits~lmax_commit_age+ltins+ldevs+lcommits+class_r, contrasts = list(class_r = Weighted_contrast_encoding(log_transform_df$class_r)), data=log_transform_df)
