...
nbr_fit = glm.nb(Sec~lmax_commit_age+ltins+ldevs+lcommits+language, contrasts = list(language = Weighted_contrast_encoding(log_transform_df$language)), data=log_transform_df)

#fitting second NBR model 
nbr_fit_r = glm.nb(Sec~lmax_commit_age+ltins+ldevs+lcommits+language_r, contrasts = list(language_r = Weighted_contrast_encoding(log_transform_df$language_r)), data=log_transform_df)
